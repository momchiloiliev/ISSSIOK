...
INSERT INTO `products`(`id`,`product_name`,`product_code`,`unit_price`) VALUES ( '1', 'IBM Mleko', '111111', '42.00' );
INSERT INTO `products`(`id`,`product_name`,`product_code`,`unit_price`) VALUES ( '2', 'Kokta 2L', '22222222', '65.00' );
COMMIT;


BEGIN;

INSERT INTO `shopping_cart`(`id`,`date_and_time`,`payment_type`) VALUES ( '1', '2014-05-09 00:44:52', '1' );
INSERT INTO `shopping_cart`(`id`,`date_and_time`,`payment_type`) VALUES ( '2', '2014-05-09 00:45:08', '2' );
COMMIT;


BEGIN;

INSERT INTO `cart_items`(`id`,`product_id`,`cart_id`,`product_amount`) VALUES ( '1', '2', '1', '2.000' );
INSERT INTO `cart_items`(`id`,`product_id`,`cart_id`,`product_amount`) VALUES ( '3', '1', '2', '5.000' );
INSERT INTO `cart_items`(`id`,`product_id`,`cart_id`,`product_amount`) VALUES ( '4', '1', '1', '1.000' );
COMMIT;
